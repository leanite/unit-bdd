...
public class GetPullRequestsMockInterceptor implements Interceptor {

    private String stateParameter;

    public GetPullRequestsMockInterceptor(String stateParameter) {
    ...
    private String getResponseMock() {
        if (stateParameter.equals("open"))
            return getStateOpenResponseMock();
        else if (stateParameter.equals("closed"))
            return getStateClosedResponseMock();
        else
            return "";
...
//        }
    ...
    private String getStateClosedResponseMock() {
        return "[\n" +
                "  {\n" +
